...
@Component({
  selector: 'app-event',
  templateUrl: './eventss.page.html',
  styleUrls: ['./eventss.page.scss'],
  standalone: true,
  imports: [ IonText, IonAvatar, IonList, IonListHeader, IonCard, 
    IonIcon,
    IonCol,
    IonRow,
    IonLabel,
...
export class EventssPage implements OnInit {
  event!: Eventt;
  ...
  getEvent(id: string) {
    this.event = this.eventS.participatedEvents.find((event) => event._id == id)!;
  }
/*
  async sendRequest() {
