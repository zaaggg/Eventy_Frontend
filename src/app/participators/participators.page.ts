...
import { AlertController, IonContent, IonHeader, IonTitle, IonToolbar, LoadingController, IonItem, IonCard, IonLabel, IonList, IonButton, IonFooter, IonAvatar, IonIcon, IonBackButton, IonButtons } from '@ionic/angular/standalone';
...
@Component({
  selector: 'app-participators',
  templateUrl: './participators.page.html',
  styleUrls: ['./participators.page.scss'],
  standalone: true,
  imports: [IonButtons, IonBackButton,  IonAvatar, IonHeader,IonToolbar,IonTitle,IonFooter,  IonList, IonLabel, IonCard, IonItem, IonContent, CommonModule, FormsModule]
})
export class ParticipatorsPage implements OnInit {
  eventId: string = '';
